...
window.CKEDITOR || (window.CKEDITOR = (function () {
  var e = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, b = {timestamp: '',
      version: '%VERSION%',
      revision: '%REV%',
      ...
      status: 'unloaded',
      basePath: (function () {
        var a = window.CKEDITOR_BASEPATH || ''; if (!a) for (var b = document.getElementsByTagName('script'), c = 0; c < b.length; c++) { var f = b[c].src.match(e); if (f) { a = f[1]; break } }a.indexOf(':/') == -1 && a.slice(0, 2) != '//' && (a = a.indexOf('/') === 0 ? location.href.match(/^.*?:\/\/[^\/]*/)[0] +
a : location.href.match(/^[^\?]*\/(?:)/)[0] + a); if (!a) throw 'The CKEditor installation path could not be automatically detected. Please set the global variable "CKEDITOR_BASEPATH" before creating editor instances.'; return a
      ...
      getUrl: function (a) { a.indexOf(':/') == -1 && a.indexOf('/') !== 0 && (a = this.basePath + a); this.timestamp && a.charAt(a.length - 1) != '/' && !/[&?]t=/.test(a) && (a += (a.indexOf('?') >= 0 ? '&' : '?') + 't=' + this.timestamp); return a },
      domReady: (function () {
        function a () {
          try {
...
if (CKEDITOR.loader) { CKEDITOR.loader.load('ckeditor') } else {
