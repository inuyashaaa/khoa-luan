...
CKEDITOR.editorConfig = function (config) {
  ...
  config.extraPlugins = 'autogrow,button,panelbutton,panel,floatpanel,colorbutton,font,bt_table,videoembed'
  config.autoGrow_minHeight = 300
  config.uploadUrl = '/uploadImg'
